...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-6 font-mono flex flex-col items-center justify-center">
      <div className="max-w-6xl w-full">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Your Projects</h2>

          {errorMessage && <p className="text-yellow-500 dark:text-red-500">{errorMessage}</p>}
          ...
          {projects.length === 0 ? (
            <div className="flex flex-col items-center justify-center bg-gray-900 p-10 rounded-lg shadow-md border border-gray-800">
              ...
              <h3 className="text-xl text-yellow-500 font-bold mb-2">No projects yet</h3>
              <p className="text-yellow-500">Start by creating your first project!</p>
            </div>
          ) : (
